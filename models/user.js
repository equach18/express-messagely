...
class User {
  ...
  static async messagesFrom(username) {
    const results = await db.query(
      `SELECT m.id, m.to_username, u.first_name, last_name, u.phone, m.body, m.sent_at, m.read_at
      FROM messages AS m
  ...
  static async messagesTo(username) {
    const results = await db.query(
      `SELECT m.id, m.from_username, u.first_name, last_name, u.phone, m.body, m.sent_at, m.read_at
      FROM messages AS m
